...
public class BluetoothCommandService {
    ...
    /**
	 * @uml.property  name="mConnectThread"
	 * @uml.associationEnd  inverse="this$0:com.mini.BluetoothCommandService$ConnectThread"
	 */
    private ConnectThread mConnectThread;
    /**
	 * @uml.property  name="mConnectedThread"
	 * @uml.associationEnd  inverse="this$0:com.mini.BluetoothCommandService$ConnectedThread"
	 */
    ...
    public static final int EXT_CMD=-1;
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothRemote.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(int out) {
            try {
                ...
                mHandler.obtainMessage(BluetoothRemote.MESSAGE_WRITE, -1, -1, out)
                        .sendToTarget();
            } catch (IOException e) {
